...
public interface PeopleRepository extends JpaRepository<Person, Integer> {
    ...
    List<Object[]> getPeopleWithPublicationsNoGrants(@Param("locName") String locName, @Param("major") String major);

    // @Query(value = "SELECT AddNewPerson(:name, :major, :hindex)", nativeQuery = true)
    // void addNewPerson(@Param("name") String name, @Param("major") String major, @Param("hindex") int hindex);

    // @Query(value = "SELECT UpdateHIndex(:name, :newHindex)", nativeQuery = true)
    // void updateHIndex(@Param("name") String name, @Param("newHindex") int newHindex);

    // @Query(value = "SELECT AddPublicationAndAssociate(:pmid, :doi, :authorName)", nativeQuery = true)
    // void addPublicationAndAssociate(@Param("pmid") String pmid, @Param("doi") String doi,
    //         @Param("authorName") String authorName);

    // @Query(value = "SELECT AssignGrantToPerson(:budgetStart, :personName)", nativeQuery = true)
    // void assignGrantToPerson(@Param("budgetStart") java.sql.Date budgetStart, @Param("personName") String personName);

    // @Query(value = "SELECT ChangePersonLocation(:personName, :locName)", nativeQuery = true)
    // void changePersonLocation(@Param("personName") String personName, @Param("locName") String locName);
}
